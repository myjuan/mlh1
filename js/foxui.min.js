...
(function () {
    ...
    var FoxUISwipe = function (swipe, params) {
        ...
        self.slide = function (activeIndex, transition) {
            // delete by chubingyu 2017/8/24/12:00
            ...
            //
            //         // $('div.fui-swipe-wrapper').css({
            //         //     "-webkit-transition": "none"
            //         // });
            //
            //
            //         // var num = -(1 * self.width);
            //         //
            //         // var transform = 'translate3d(' + num + 'px,0,0)';
            //         //
            //         // $('div.fui-swipe-wrapper').css({
        ...
        self.begin = function () {
            if (self.params.speed) {
                ...
                self.interval = setTimeout(function () {
                    //edit by chubingyu 2017/8/24/12:00
                    if(self.wrapper.hasClass('detail-swipe')){
                        self.next()
                    }else{
                        clearTimeout(self.interval)
                    }
